...
def build_augmentations(train: bool = True):
    if train:
        train_transform = [
            transforms.RandSpatialCropSamplesd(keys=["image", "label"], roi_size=(160, 320, 320), num_samples=4, random_center=True, random_size=False),
            ...
            transforms.RandCoarseDropoutd(keys=["image", "label"], holes=20, spatial_size=(-1, 7, 7, 7), fill_value=0, prob=0.5),
